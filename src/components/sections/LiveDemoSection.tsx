      ...
      <div className="container relative z-10 mx-auto px-6 max-w-5xl">
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-foreground/[0.06] bg-foreground/[0.03] mb-5 text-xs font-medium text-accent-muted uppercase tracking-[0.15em]">
            <Sparkles size={12} className="text-accent-muted" />
            Live Demo
          </div>
        ...
        <div className="glass-panel rounded-2xl border border-foreground/[0.06] overflow-hidden shadow-[0_0_60px_rgba(255,255,255,0.03)] shimmer-border">
          ...
          <div className="p-7 font-mono text-sm grid md:grid-cols-2 gap-6 min-h-[380px]">
            ...
            <div className="space-y-5">
              <div>
                <div className="flex items-center gap-2 text-accent-muted mb-2 text-xs">
                  <Terminal size={14} />
                ...
                <div className="bg-background/30 border border-foreground/[0.06] rounded-xl p-4 text-gray-300 min-h-[52px] flex items-center">
                  ...
                  <motion.span
                    ...
                    className="inline-block w-1.5 h-4 bg-foreground ml-1 rounded-sm"
                  />
                </div>
              </div>
              ...
              <AnimatePresence>
                {step >= 1 && (
                  <motion.div
                    ...
                    className="space-y-4"
                  >
                    <div className="flex items-center gap-2 text-accent-muted text-xs">
                      <Cpu size={14} className={step === 1 ? "animate-spin" : ""} />
                      <span>{step === 1 ? "NLP Engine Processing..." : "Entity Extraction Complete"}</span>
                      {step >= 2 && <CheckCircle2 size={14} className="text-foreground" />}
                    </div>
                    ...
                    {step >= 2 && (
                      ...
                      >
                        <div className="flex justify-between items-center border-b border-foreground/[0.04] pb-2">
                          ...
                          <span className="text-foreground font-medium">Sector 7</span>
                        </div>
                        <div className="flex justify-between items-center border-b border-foreground/[0.04] pb-2">
                        ...
                        <div className="flex justify-between items-center border-b border-foreground/[0.04] pb-2">
                          ...
                          <span className="text-foreground flex items-center gap-1 font-semibold"><AlertTriangle size={12}/>HIGH</span>
                        </div>
