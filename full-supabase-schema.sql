-- ===========================================================================
-- IMPACT HUB: COMPLETE SUPABASE SCHEMA SETUP
-- Copy and paste this entire script into your Supabase SQL Editor and run it.
-- This will create all required tables for the full-stack project.
-- ===========================================================================
...
CREATE TABLE IF NOT EXISTS public.incidents (
  ...
  status TEXT NOT NULL DEFAULT 'Active' CHECK (status IN ('Processing', 'Active', 'In Transit', 'Resolved')),
  affected TEXT,
  description TEXT,
